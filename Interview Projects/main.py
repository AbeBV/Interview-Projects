...
def get_dataCSV(filename, indexCol = True):
	if indexCol == True:
		...
		return df
dfSharpe = get_dataCSV('Interview Projects/SharpeRatios_1.csv')
dfAlpha = get_dataCSV('Interview Projects/AlphaOfFunds.csv')
dfCumulRet_Sharpe = get_dataCSV('Interview Projects/Cumulative Returns Sharpe.csv')
dfCumulRet_Alpha = get_dataCSV('Interview Projects/Cumulative Returns Alpha.csv')
dfSharpeYearsandWeights =  get_dataCSV('Interview Projects/Sharpe Weights and Accounts.csv')
dfAlphaYearsandWeights = get_dataCSV('Interview Projects/Alpha Weights and Accounts.csv')
dfFuturePortfolio = get_dataCSV('Interview Projects/Combined Future Alpha Sharpe Portfolio.csv', False)
